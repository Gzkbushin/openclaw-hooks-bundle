...
export type ConfigObjectSchema = {
  type: "object";
  properties: Record<string, ConfigPropertySchema>;
};

export type ResolvePluginConfigOptions = {
  pluginKeys?: string[];
...
export function loadConfigObjectFile(filePath: string, logger?: Logger): Record<string, unknown> {
  return loadObjectFile(filePath, logger);
}
